function params = run_realtime_STRCF(params, handles, res_path, bSaveImage)
...
if ~(params.seq.isFirst)
    ...
    params.search_area_shape = 'custom';    % The shape of the samples
...
% Run tracker
params = realtime_tracker(params, handles);
